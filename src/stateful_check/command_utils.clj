...
(defn check-postcondition
  ...
  key describing the failure. If the postcondition made any Clojure
  Test assertions, events of type :fail and :error are added to the
  result under the :events key."
